...
namespace week05
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            birthday_party mehka = new birthday_party();
            mehka.setupPartyList();
            mehka.reverseprintPartyList();
            Console.WriteLine(mehka.printPartyList());
            Console.WriteLine(mehka.reverseprintPartyList());
